...
const PaymentscashfreedashboardOnePage = () => {
  ...
  return (
    <>
      <div className="bg-gray-50 flex flex-col font-inter items-center h-full justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start h-full justify-evenly w-full">
          <Sidebar
            onClick={() => collapseSidebar(!collapsed)}
            className="!sticky !w-56 bg-blue_gray-900 flex h-screen md:hidden justify-start md:px-5 top-[0]"
          >
            <div className="flex flex-row gap-3 items-center justify-start mt-4 mx-auto w-48">
              ...
              {/* if the value of collapsed is true then don't show this div  */}
              
              <div
                className={`${
                  collapsed ? "hidden" : "flex"
                } flex-col gap-1 items-start justify-center w-full`}
              >
                <Text
            ...
            <Menu
              ...
              className="flex flex-col items-center justify-between h-full mt-3.5 pt-[9px] px-2 w-[93%]"
            >
              ...
              {/* This is the available credits div  */}
              <div className="flex flex-col items-center justify-between pb-[15px] w-full">
                <MenuItem
                  icon={
                    <Img
                      className="mt-2 h-6 w-6 flex flex-col"
                ...
                > 
                <div>
                  <p className="text-[13px] w-auto">Available credits </p>
                  <p className=" font-medium text-white-A700">222.10</p>
                </div>
          ...
          <div className="flex flex-1 flex-col gap-8 items-center justify-start md:px-5 w-full">
            <PaymentsCashfreeDashboardOneRowframe2282 className="" />
            <div className="flex flex-col gap-8 items-start justify-start max-w-6xl w-full">
              ...
              <div className="flex flex-col gap-5 items-start justify-start w-auto md:w-full">
                ...
                <div className="bg-white-A700 flex flex-col items-end justify-start pb-6 pt-3 px-3 rounded-lg shadow-bs w-auto md:w-full">
                  <div className="flex flex-col gap-3 items-end justify-between w-full md:w-full">
